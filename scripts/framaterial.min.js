...
$(function(){var ink,d,x,y;$("a[class*='btn']").click(function(e){if($(this).find(".ink").length===0){$(this).prepend("<div class='ink'></div>");}
...
x=e.pageX-$(this).offset().left-ink.width()/2;y=e.pageY-$(this).offset().top-ink.height()/2;ink.css({top:y+'px',left:x+'px'}).addClass("animate");});});function navigation(){var navigation=$('[class*="material-navigation"]');function subNavigation(){var subNavigation=navigation.find('.sub-navigation');subNavigation.each(function(){var $this=$(this);var navigationParent=$this.parent().closest('[class*="material-navigation"]')
navigationParent.addClass('sub-nav');if($('body').find('nav[class*="material-sidebar-left"]')){if($('nav[class*="material-sidebar"]').attr('data-state')=='closed'){var shrunk=$('nav[class*="material-sidebar"]').width();$this.addClass('shrunked').attr('data-shrunk',shrunk);$this.css({'width':'100%','float':'right','right':'0','position':'relative','top':'0px','box-shadow':'inset 2px 2px 4px rgba(0,0,0,.3)'})}
else{var shrunk=$('nav[class*="material-sidebar"]').width();$this.addClass('shrunked').attr('data-shrunk',shrunk);$this.css({'width':'calc(100% - '+shrunk+'px)','float':'right','right':'0','position':'relative','top':'60px','box-shadow':'inset 2px 2px 4px rgba(0,0,0,.3)'})}
$('*').on('click',function(){if($('nav[class*="material-sidebar"]').attr('data-state')=='closed'){var shrunk=$('nav[class*="material-sidebar"]').width();$this.addClass('shrunked').attr('data-shrunk',shrunk);$this.css({'width':'100%','float':'right','right':'0','position':'relative','top':'0','box-shadow':'inset 2px 2px 4px rgba(0,0,0,.3)'})}
else{var shrunk=$('nav[class*="material-sidebar"]').width();$this.addClass('shrunked').attr('data-shrunk',shrunk);$this.css({'width':'calc(100% - '+shrunk+'px)','float':'right','right':'0','position':'relative','top':'60px','box-shadow':'inset 2px 2px 4px rgba(0,0,0,.3)'})}});}
else if($('body').find('nav[class*="material-sidebar-right"]')){if($('nav[class*="material-sidebar"]').attr('data-state')=='closed'){var shrunk=$('nav[class*="material-sidebar"]').width();$this.addClass('shrunked').attr('data-shrunk',shrunk);$this.css({'width':'100%','float':'left','left':'0','position':'relative','top':'60px','box-shadow':'inset 2px 2px 4px rgba(0,0,0,.3)'})}
else{var shrunk=$('nav[class*="material-sidebar"]').width();$this.addClass('shrunked').attr('data-shrunk',shrunk);$this.css({'width':'calc(100% - '+shrunk+'px)','float':'left','left':'0','position':'relative','top':'60px','box-shadow':'inset 2px 2px 4px rgba(0,0,0,.3)'})}
$('*').on('click',function(){if($('nav[class*="material-sidebar"]').attr('data-state')=='closed'){var shrunk=$('nav[class*="material-sidebar"]').width();$this.addClass('shrunked').attr('data-shrunk',shrunk);$this.css({'width':'100%','float':'left','left':'0','position':'relative','top':'0','box-shadow':'inset 2px 2px 4px rgba(0,0,0,.3)'})}
else{var shrunk=$('nav[class*="material-sidebar"]').width();$this.addClass('shrunked').attr('data-shrunk',shrunk);$this.css({'width':'calc(100% - '+shrunk+'px)','float':'left','left':'0','position':'relative','top':'60px','box-shadow':'inset 2px 2px 4px rgba(0,0,0,.3)'})}});}
else{}});}
subNavigation();}
...
function toastsSnackbar(){var toasts=$('[data-toggle*="toast"]');var snacks=$('[data-toggle*="snackbar"]');var idToast=0;var idSnack=0;toasts.each(function(){var $this=$(this);var posY=$this.attr('data-toast-posy');var posX=$this.attr('data-toast-posx');var content=$this.attr('data-toast-inner');var fadeTime=$this.attr('data-toast-fade-time');var fadeTime=fadeTime*1000;idToast++;if(!fadeTime){$this.attr('data-toast-fade-time','4');}
...
snacks.each(function(){var $this=$(this);var posY=$this.attr('data-snackbar-posy');var posX=$this.attr('data-snackbar-posx');var content=$this.attr('data-snackbar-inner');idSnack++;$this.attr('id','call_snackbar_'+idSnack)
