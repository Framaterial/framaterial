...
tpl     = {
    ...
    head    : function (d) {
        ...
        '<header>' +
        '<div class="pmu-today-h"></div>'+
        '<div class="pmu-month"></div>'+
        '<div class="pmu-view-days-num"></div>'+
        '<div class="pmu-view-year-num"></div>'+
//                        '<div class="pmu-month pmu-button" />' +
//'<div class="pmu-prev pmu-button">' + d.prev + '
...
function fill () {
    ...
    tmp_date;
         ...
         */
         pickmeup.find('.pmu-instance > :not(header)').remove();
        /**
...
$(function () {
  $('[data-card-type="datepicker"]').pickmeup({
    flat  : true
});
  // $('.multiple').pickmeup({
  //   flat  : true,
